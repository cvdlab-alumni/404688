...
var circle = function (x,r) {
	...
	var p0 = [[0,0,0],[0,0,r],t1,t2];
	var p1 = [[0,x,0],[0,x,r],t1,t2];
	var p2 = [[0,0,0],[0,0,r],t2,t1];
	var p3 = [[0,x,0],[0,x,r],t2,t1];
...
var tail = function (y,z,r1,r2) {
	...
	var p0 = [[0,0,0],[0,0,r1],t11,t21];
	var p1 = [[0,y,z],[0,y,z+r2],t12,t22];

	var p2 = [[0,0,0],[0,0,r1],t21,t11];
	var p3 = [[0,y,z],[0,y,z+r2],t22,t12];
...
var nose = function(y1,z1,y2,z2,r1,r2,r3){
	...
	var p0 = [[0,0,0],[0,0,r1],t11,t21];
	var p1 = [[0,y1,z1],[0,y1,z1+r2],t12,t22];

	var p5 = [[0,y2,z2],[0,y2,z2+r3],t31,t32];


	var p2 = [[0,0,0],[0,0,r1],t21,t11];
	var p3 = [[0,y1,z1],[0,y1,z1+r2],t22,t12];

	var p6 = [[0,y2,z2],[0,y2,z2+r3],t32,t31];
...
var sph = T([1,2])([13,2.5])(Sphere(0.5,30,[1,0,0,1]));

var planeTail = tail(10,2,5,2);
var yu = R([0,1])(PI)(planeTail);
//DRAW(yu);
